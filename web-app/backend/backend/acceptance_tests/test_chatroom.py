...
#             EC.element_to_be_clickable((By.CSS_SELECTOR, '[data-name="Chat"]'))
#         )
...
#         chat_room = WebDriverWait(self.browser, 10).until(
#             EC.presence_of_element_located((By.CSS_SELECTOR, "div[data-name='Test chat']"))
#         )
#         chat_room.click()
#         time.sleep(5)
        
#         message_field = WebDriverWait(self.browser, 10).until(

...
from .views import NotificationListView, NotificationDeleteView, ListPtAndUserView, CreatePersonalTrainerScheduledWorkoutView, PersonalTrainerScheduledWorkoutListView, PersonalTrainerScheduledWorkoutDeleteView

...
import type { Workout, Exercise, WorkoutSession, Notification, chatRoom, PT } from "~/types"; // Import types for workouts and exercises
...
export const CustomerDashboard: React.FC = () => {
    ...
    useEffect(() => {
        ...
        const fetchUserChatRooms = async () => {
          ...
          // Fetch trainer data and find current user's trainer
          ...
          // Fetch the chat room ID for the chat room with user's personal trainer
    ...
    return (
      ...
      >
        ...
        <motion.div className="flex flex-row flex-grow gap-x-6 w-full">
              ...
              <h2 className="text-xl font-bold mb-4">My Personal Trainer</h2>
                <motion.div className="flex items-center justify-center space-x-4">
                  <div className="w-17 h-17 rounded-full overflow-hidden flex-shrink-0 ring-2 ring-gray-600">
                    ...
                    {/* Button to directly open chat with personal trainer */}
                    <motion.button
          ...
          {/* Main Panel: Middle + Right section or Chat Room */}
          {/* Check if the user has opened the chat room, if it is, display the chatroom */}
          <AnimatePresence mode="wait">
            ...
            >
              {/* Chat room closed, display workout feed */}
                ...
                {workoutSessions.length === 0 ? (
                  ...
                  <div className="space-y-4 w-full">
                    ...
                    return (
                      <div
                        key={session.id}
                        className="p-2 bg-gray-800 rounded flex flex-col"
                      >
                        {/* Workout name */}
                        ...
                        {/* Exercises with performed sets, reps and weight */}
                        <div className="mt-3">
                          <div className="mt-2">
                            
                            {/* Check that the exercises exist */}
